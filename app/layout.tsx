...
export const metadata: Metadata = {
  title: `${BrandTitles_Output.Home} Generator for Testing`,
  description: "Generate phone numbers for testing purposes across multiple countries and regions with our versatile tool.",
  icons: [
